package dz.deepwork.gamemn02.notekeeper.main;
...
import dz.deepwork.gamemn02.notekeeper.writing.WritingActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = WritingActivity.createIntent(
                        MainActivity.this,
                        WritingActivity.NOTE_INDEX_NEW_NOTE);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = WritingActivity.createIntent(MainActivity.this, i);
                startActivity(intent);
            }
        });
